...
export const CERTIFICATION_FAIRNESS_POINTS = [
  '공식 인증 랭킹은 모바일 앱에서 AR+AI로 촬영한 기록만 반영됩니다.',
  '웹에서는 랭킹 조회·자랑 기록·커뮤니티를 이용할 수 있습니다.',
  '앱 실시간 촬영만 허용해 미리 찍은 사진·타인 사진 도용을 원천 차단합니다.',
  'S/A/B 등급은 AI 검증 결과로만 부여되며, B등급은 랭킹에 반영되지 않습니다.',
  'FishRank에 등록된 동일 사진(해시 일치)은 재업로드·도용 시 차단됩니다.',
  '랭킹 점수 = 길이(cm) × 어종 가중치 — 촬영 방식이 아닌 기록 품질로만 경쟁합니다.',
] as const;
